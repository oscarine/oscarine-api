...
Revision ID: daf1eaa11951
Revises: 30c3d93498d1
Create Date: 2020-06-26 01:17:43.981910
...
def upgrade():
    ...
    op.add_column('shops', sa.Column('is_available', sa.Boolean(), nullable=True))
...
def downgrade():
    ...
    op.drop_column('shops', 'is_available')
